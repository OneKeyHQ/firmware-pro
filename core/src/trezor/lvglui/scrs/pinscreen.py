...
from . import font_GeistRegular26, font_GeistSemiBold48, font_GeistSemiBold26
from .common import FullSizeWindow, lv, lv_colors  # noqa: F401,F403
from .components.button import NormalButton
from .components.container import ContainerFlexCol
from .components.keyboard import NumberKeyboard, IndexKeyboard
...
class InputNum(FullSizeWindow):
    ...
    def __init__(self, **kwargs):
        ...
        self.keyboard = IndexKeyboard(self, min_len=1, max_len=11, is_pin=kwargs.get("is_pin", True))
