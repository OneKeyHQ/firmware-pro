...
class DeviceInfoManager:
    ...
    def preload_device_info(self):
        ...
        onekey_se01_version = self.format_version(
            onekey_se01_version, onekey_se01_build_id, onekey_se01_short_hash
        )
        ...
        onekey_se02_version = self.format_version(
            onekey_se02_version, onekey_se02_build_id, onekey_se02_short_hash
        )
        ...
        onekey_se03_version = self.format_version(
            onekey_se03_version, onekey_se03_build_id, onekey_se03_short_hash
        )
        ...
        onekey_se04_version = self.format_version(
            onekey_se04_version, onekey_se04_build_id, onekey_se04_short_hash
        )
        ...
        onekey_se01_boot_version = self.format_version(
            onekey_se01_boot_version,
            onekey_se01_boot_build_id,
            onekey_se01_boot_short_hash,
        )
        ...
        onekey_se02_boot_version = self.format_version(
            onekey_se02_boot_version,
            onekey_se02_boot_build_id,
            onekey_se02_boot_short_hash,
        )
        ...
        onekey_se03_boot_version = self.format_version(
            onekey_se03_boot_version,
            onekey_se03_boot_build_id,
            onekey_se03_boot_short_hash,
        )
        ...
        onekey_se04_boot_version = self.format_version(
            onekey_se04_boot_version,
            onekey_se04_boot_build_id,
            onekey_se04_boot_short_hash,
        )
