...
translations = [
    ...
    "Open your OneKey App and choose any wallpaper image for your lock screen or home screen.",
    "Pair",
    "Blur",
    ...
    "Multi-share",
    "Enter a Valid Share",
    "The Recovery Phrase Share you entered is incorrect. Please enter the correct Share.",
