...
/**
  ...
  \param[in]  reset             reset if already configured (0:no reset,
  1:reset)
*/
...
*/
extern void EvrFreeRTOSTasks_TaskPrioritySet(TCB_t pxTCB,
...
/**
  ...
  \param[in]  xTicksToJump      number of ticks by which the tick count is
  increased.
*/
...
/**
  ...
  \param[in]  pxCurrentTCB      handle to the task about to leave the running
  state.
*/
...
/**
  ...
  \param[in]  pxCurrentTCB      handle to the task about to enter the running
  state. \param[in]  uxTopPriority     pxCurrentTCB task priority.
*/
extern void EvrFreeRTOSTasks_TaskSwitchedIn(TCB_t pxCurrentTCB,
...
*/
extern void EvrFreeRTOSTasks_TaskPriorityInherit(TCB_t pxTCBOfMutexHolder,
...
*/
extern void EvrFreeRTOSTasks_TaskPriorityDisinherit(
    TCB_t pxTCBOfMutexHolder, uint32_t uxOriginalPriority);
...
/**
  \brief  Event on indicating the current running task is about to block while
  waiting for notification to be non-zero (Op) \param[in]  uxIndexToWait task
  notification index. \param[in]  xTicksToWait      wait timeout in ticks.
*/
extern void EvrFreeRTOSTasks_TaskNotifyTakeBlock(uint32_t uxIndexToWait,
...
*/
extern void EvrFreeRTOSTasks_TaskNotifyTake(uint32_t uxIndexToWait,
                                            uint32_t ulNotifiedValue);

/**
  \brief  Event indicating the current running task is about to block while
  waiting to receive notification (Op) \param[in]  uxIndexToWait     task
  notification index \param[in]  xTicksToWait      wait timeout in ticks.
*/
extern void EvrFreeRTOSTasks_TaskNotifyWaitBlock(uint32_t uxIndexToWait,
                                                 uint32_t xTicksToWait);
...
/**
  ...
  \param[in]  ulNotifiedValue   current state of the notification value.
*/
extern void EvrFreeRTOSTasks_TaskNotifyWait(uint32_t uxIndexToWait,
                                            uint32_t ulNotifiedValue);
...
/**
  ...
  \param[in]  ulNotifiedValue   current state of the notification value.
*/
extern void EvrFreeRTOSTasks_TaskNotify(TCB_t xTaskToNotify,
...
/**
  ...
  \param[in]  ulNotifiedValue   current state of the notification value.
*/
extern void EvrFreeRTOSTasks_TaskNotifyFromIsr(TCB_t xTaskToNotify,
                                               uint32_t uxIndexToWait,
                                               uint32_t eAction,
                                               uint32_t ulNotifiedValue);
...
/**
  ...
  \param[in]  ulNotifiedValue   current state of the notification value.
*/
extern void EvrFreeRTOSTasks_TaskNotifyGiveFromIsr(TCB_t xTaskToNotify,
                                                   uint32_t uxIndexToWait,
                                                   uint32_t ulNotifiedValue);
...
/**
  ...
  \param[in] pxTaskBuffer       pointer to buffer to be used for task control
  block.
*/
extern void EvrFreeRTOSTasks_xTaskCreateStatic(
...
/**
  ...
  \param[in] puxStackBuffer     pointer to buffer to be used for task stack.
  \param[in] pxTaskBuffer       pointer to buffer to be used for task control
  block. \param[in] uxCoreAffinityMask task affinity mask.
*/
extern void EvrFreeRTOSTasks_xTaskCreateStaticAffinitySet(
    void *pxTaskCode, const char *pcName, const uint32_t ulStackDepth,
    void *pvParameters, uint32_t uxPriority, void *puxStackBuffer,
...
/**
  ...
  \param[in]  pxTaskDefinition  pointer to parameters required to create an MPU
  protected task. \param[in]  pxCreatedTask     pointer to where the created
  task handle is stored.
*/
extern void EvrFreeRTOSTasks_xTaskCreateRestrictedStatic(
...
*/
extern void EvrFreeRTOSTasks_xTaskCreateRestrictedStatic_Return(
    uint32_t xReturn);

/**
  \brief Event sent when function xTaskCreateRestrictedStaticAffinitySet is
  called (API). \param[in]  pxTaskDefinition   pointer to parameters required to
  create an MPU protected task. \param[in]  uxCoreAffinityMask affinity mask
  \param[in]  pxCreatedTask      pointer to where the created task handle is
  stored.
*/
extern void EvrFreeRTOSTasks_xTaskCreateRestrictedStaticAffinitySet(
    const TaskParameters_t *pxTaskDefinition, UBaseType_t uxCoreAffinityMask,
    TaskHandle_t *pxCreatedTask);

/**
  \brief Event sent before function xTaskCreateRestrictedStaticAffinitySet
  returns (Op). \param[in]  xReturn           return status.
*/
extern void EvrFreeRTOSTasks_xTaskCreateRestrictedStaticAffinitySet_Return(
    uint32_t xReturn);
...
/**
  ...
  task handle is stored.
*/
extern void EvrFreeRTOSTasks_xTaskCreateRestricted(
    const TaskParameters_t *pxTaskDefinition, TaskHandle_t *pxCreatedTask);
...
/**
  \brief Event sent when function xTaskCreateRestrictedAffinitySet is called
  (API). \param[in]  pxTaskDefinition   pointer to parameters required to create
  an MPU protected task. \param[in]  uxCoreAffinityMask affinity mask.
  \param[in]  pxCreatedTask      pointer to where the created task handle is
  stored.
*/
extern void EvrFreeRTOSTasks_xTaskCreateRestrictedAffinitySet(
    TaskParameters_t *pxTaskDefinition, uint32_t uxCoreAffinityMask,
    /*TCB_t*/ void *pxCreatedTask);

/**
  \brief Event sent before function xTaskCreateRestrictedAffinitySet returns
  (Op). \param[in]  xReturn           return status.
*/
extern void EvrFreeRTOSTasks_xTaskCreateRestrictedAffinitySet_Return(
    uint32_t xReturn);
...
/**
  ...
  stored.
*/
extern void EvrFreeRTOSTasks_xTaskCreate(void *pxTaskCode, const char *pcName,
...
/**
  ...
  stored.
*/
extern void EvrFreeRTOSTasks_xTaskCreateAffinitySet(
...
/**
  ...
  \param[in]  pxPreviousWakeTime pointer to variable that holds the task last
  unblock time. \param[in]  xTimeIncrement     the cycle time period.
*/
extern void EvrFreeRTOSTasks_xTaskDelayUntil(uint32_t *pxPreviousWakeTime,
...
/**
  ...
  \param[in]  xTicksToDelay      the number of ticks that the calling task
  should block.
*/
...
*/
extern void EvrFreeRTOSTasks_vTaskPrioritySet(TaskHandle_t xTask,
                                              uint32_t uxNewPriority);
...
*/
extern void EvrFreeRTOSTasks_vTaskCoreAffinitySet(TaskHandle_t xTask,
...
*/
extern void EvrFreeRTOSTasks_vTaskCoreAffinityGet_Return(
    uint32_t uxCoreAffinityMask);
...
/**
  ...
  \param[in]  xYieldRequired     info if resuming a task results in a context
  switch
*/
...
/**
  ...
  \param[in]  xAlreadyYielded    info if resuming the scheduler caused a context
  switch.
*/
...
*/
extern void EvrFreeRTOSTasks_uxTaskGetNumberOfTasks_Return(
...
/**
  ...
  \param[in]  xTask              task handle.
  \param[in]  ppuxStackBuffer    pointer to location where pointer to task stack
  buffer is stored. \param[in]  ppxTaskBuffer      pointer to location where
  pointer to task data structure is stored.
*/
extern void EvrFreeRTOSTasks_xTaskGetStaticBuffers(
...
*/
extern void EvrFreeRTOSTasks_uxTaskGetSystemState(
    TaskStatus_t *pxTaskStatusArray, const uint32_t uxArraySize,
...
/**
  ...
  \param[in]  xTask             task handle.
*/
extern void EvrFreeRTOSTasks_xTaskGetIdleTaskHandleForCore_Return(
    TaskHandle_t xTask);
...
*/
extern void EvrFreeRTOSTasks_xTaskIncrementTick_Return(
    uint32_t xSwitchRequired);
...
*/
extern void EvrFreeRTOSTasks_vTaskSetApplicationTaskTag(
...
*/
extern void EvrFreeRTOSTasks_xTaskGetApplicationTaskTag_Return(
    TaskHookFunction_t xReturn);

/**
  \brief Event sent when function xTaskGetApplicationTaskTagFromISR is called
  (API). \param[in]  xTask             task handle.
*/
extern void EvrFreeRTOSTasks_xTaskGetApplicationTaskTagFromISR(
    TaskHandle_t xTask);

/**
  \brief Event sent before function xTaskGetApplicationTaskTagFromISR returns
  (Op). \param[in]  xReturn           hook function used by the task xTask.
*/
extern void EvrFreeRTOSTasks_xTaskGetApplicationTaskTagFromISR_Return(
    TaskHookFunction_t xReturn);

/**
  \brief Event sent when function xTaskCallApplicationTaskHook is called (API).
  \param[in]  xTask             task handle.
  \param[in]  pvParameter       pointer to parameters passed to the hook
  function.
*/
extern void EvrFreeRTOSTasks_xTaskCallApplicationTaskHook(TaskHandle_t xTask,
                                                          void *pvParameter);
...
*/
extern void EvrFreeRTOSTasks_xTaskCallApplicationTaskHook_Return(
    uint32_t xReturn);
...
/**
  ...
  \param[in]  pxEventList       pointer to the blocked task list waiting for
  event. \param[in]  xTicksToWait      amount of time to wait for an event.
*/
extern void EvrFreeRTOSTasks_vTaskPlaceOnEventList(
    List_t *pxEventList, const TickType_t xTicksToWait);
...
/**
  \brief Event sent when function vTaskPlaceOnUnorderedEventList is called
  (API). \param[in]  pxEventList       pointer to the blocked task list waiting
  for event. \param[in]  xItemValue        value to use when event list is not
  ordered by priority. \param[in]  xTicksToWait      amount of time to wait for
  an event.
*/
extern void EvrFreeRTOSTasks_vTaskPlaceOnUnorderedEventList(
...
/**
  \brief Event sent when function vTaskPlaceOnEventListRestricted is called
  (API). \param[in]  pxEventList       pointer to the blocked task list waiting
  for event. \param[in]  xTicksToWait      amount of time to wait for an event.
  \param[in]  xWaitIndefinitely whether the task should block indefinitely.
*/
extern void EvrFreeRTOSTasks_vTaskPlaceOnEventListRestricted(
    List_t *pxEventList, TickType_t xTicksToWait,
    const uint32_t xWaitIndefinitely);

/**
  \brief Event sent before function vTaskPlaceOnEventListRestricted returns
  (Op).
*/
...
*/
extern void EvrFreeRTOSTasks_xTaskRemoveFromEventList(
...
/**
  \brief Event sent when function vTaskRemoveFromUnorderedEventList is called
  (API). \param[in]  pxEventListItem   pointer to the event list. \param[in]
  xItemValue        event list item value.
*/
extern void EvrFreeRTOSTasks_vTaskRemoveFromUnorderedEventList(
    ListItem_t *pxEventListItem, const TickType_t xItemValue);

/**
  \brief Event sent before function vTaskRemoveFromUnorderedEventList returns
  (Op).
*/
...
/**
  ...
  \param[in]  pxTimeOut         pointer to the timeout object.
  \param[in]  pxTicksToWait     pointer to object holding number of ticks to
  check for timeout.
*/
extern void EvrFreeRTOSTasks_xTaskCheckForTimeOut(TimeOut_t *pxTimeOut,
...
*/
extern void EvrFreeRTOSTasks_vTaskSetTaskNumber(TaskHandle_t xTask,
...
*/
extern void EvrFreeRTOSTasks_eTaskConfirmSleepModeStatus_Return(
    eSleepModeStatus eReturn);

/**
  \brief Event sent when function vTaskSetThreadLocalStoragePointer is called
  (API). \param[in]  xTaskToSet        task handle. \param[in]  xIndex array
  index. \param[in]  pvValue           value to set.
*/
extern void EvrFreeRTOSTasks_vTaskSetThreadLocalStoragePointer(
    TaskHandle_t xTaskToSet, uint32_t xIndex, void *pvValue);

/**
  \brief Event sent before function vTaskSetThreadLocalStoragePointer returns
  (Op).
*/
extern void EvrFreeRTOSTasks_vTaskSetThreadLocalStoragePointer_Return(void);

/**
  \brief Event sent when function pvTaskGetThreadLocalStoragePointer is called
  (API). \param[in]  xTaskToQuery      task handle. \param[in]  xIndex array
  index.
*/
extern void EvrFreeRTOSTasks_pvTaskGetThreadLocalStoragePointer(
    TaskHandle_t xTaskToQuery, uint32_t xIndex);

/**
  \brief Event sent before function pvTaskGetThreadLocalStoragePointer returns
  (Op). \param[in]  pvReturn          retrieved value.
*/
...
/**
  ...
  \param[in]  pxRegions         pointer to a structure that contains memory
  region definitions.
*/
extern void EvrFreeRTOSTasks_vTaskAllocateMPURegions(
    TaskHandle_t xTaskToModify, const MemoryRegion_t *pxRegions);
...
/**
  ...
  \param[in]  xTask              task handle.
  \param[in]  pxTaskStatus       pointer to the structure that will be filled
  with info. \param[in]  xGetFreeStackSpace parameter that allows the high water
  mark checking to be skipped. \param[in]  eState             parameter that
  allows the state information to be omitted.
*/
extern void EvrFreeRTOSTasks_vTaskGetInfo(TaskHandle_t xTask,
...
/**
  ...
  \param[in]  uxReturn           the smallest amount (in words) of free stack
  space there has been.
*/
extern void EvrFreeRTOSTasks_uxTaskGetStackHighWaterMark2_Return(
    uint32_t uxReturn);
...
/**
  ...
  space there has been.
*/
extern void EvrFreeRTOSTasks_uxTaskGetStackHighWaterMark_Return(
    uint32_t uxReturn);
...
*/
extern void EvrFreeRTOSTasks_xTaskGetCurrentTaskHandle_Return(
    TaskHandle_t xReturn);

/**
  \brief Event sent when function xTaskGetCurrentTaskHandleForCore is called
  (API). \param[in]  xCoreID            processor core ID.
*/
extern void EvrFreeRTOSTasks_xTaskGetCurrentTaskHandleForCore(uint32_t xCoreID);

/**
  \brief Event sent before function xTaskGetCurrentTaskHandleForCore returns
  (Op). \param[in]  xReturn            task handle.
*/
extern void EvrFreeRTOSTasks_xTaskGetCurrentTaskHandleForCore_Return(
    TaskHandle_t xReturn);
...
/**
  ...
  \param[in]  pxMutexHolder      task handle.
*/
extern void EvrFreeRTOSTasks_xTaskPriorityDisinherit(
...
/**
  \brief Event sent when function vTaskPriorityDisinheritAfterTimeout is called
  (API). \param[in]  pxMutexHolder                task handle. \param[in]
  uxHighestPriorityWaitingTask the priority of the highest priority task that is
  waiting for mutex.
*/
extern void EvrFreeRTOSTasks_vTaskPriorityDisinheritAfterTimeout(
    TaskHandle_t pxMutexHolder, uint32_t uxHighestPriorityWaitingTask);

/**
  \brief Event sent before function vTaskPriorityDisinheritAfterTimeout returns
  (Op).
*/
...
*/
extern void EvrFreeRTOSTasks_vTaskEnterCriticalFromISR_Return(
...
/**
  ...
  \param[in]  uxSavedInterruptStatus  saved interrupt status.
*/
extern void EvrFreeRTOSTasks_vTaskExitCriticalFromISR(
    uint32_t uxSavedInterruptStatus);
...
*/
extern void EvrFreeRTOSTasks_vTaskListTasks(char *pcWriteBuffer,
...
/**
  ...
  \param[in]  uxBufferLength     length of the pcWriteBuffer.
*/
extern void EvrFreeRTOSTasks_vTaskGetRunTimeStatistics(char *pcWriteBuffer,
                                                       size_t uxBufferLength);
...
*/
extern void EvrFreeRTOSTasks_uxTaskResetEventItemValue_Return(
    TickType_t uxReturn);
...
*/
extern void EvrFreeRTOSTasks_pvTaskIncrementMutexHeldCount_Return(
    /*TCB_t*/ void *pxTCB);

/**
  \brief Event sent when function ulTaskGenericNotifyTake is called (API).
  \param[in]  uxIndexToWaitOn    index within the tasks array of notification
  values. \param[in]  xClearCountOnExit  indication whether to clear
  notification value. \param[in]  xTicksToWait       amount of time to wait.
*/
extern void EvrFreeRTOSTasks_ulTaskGenericNotifyTake(
...
/**
  ...
  \param[in]  uxIndexToWaitOn      index within the tasks array of notification
  values. \param[in]  ulBitsToClearOnEntry bits that shall be cleared before
  reading notification value. \param[in]  ulBitsToClearOnExit  bits that shall
  be cleared before returning. \param[in]  pulNotificationValue pointer to
  variable where notification value will be stored. \param[in]  xTicksToWait
  amount of time to wait.
*/
extern void EvrFreeRTOSTasks_xTaskGenericNotifyWait(
...
/**
  ...
  \param[in]  uxIndexToNotify              index within the tasks array of
  notification values. \param[in]  ulValue                      notification
  data value. \param[in]  eAction                      specifies how is the task
  notification value updated. \param[in]  pulPreviousNotificationValue pointer
  to variable where notification value will be stored.
*/
extern void EvrFreeRTOSTasks_xTaskGenericNotify(
...
/**
  ...
  data value. \param[in]  eAction                      specifies how is the task
  notification value updated. \param[in]  pulPreviousNotificationValue pointer
  to variable where notification value will be stored. \param[in]
  pxHigherPriorityTaskWoken    pointer to variable where information if any task
  was woken will be stored.
*/
extern void EvrFreeRTOSTasks_xTaskGenericNotifyFromISR(
    TaskHandle_t xTaskToNotify, UBaseType_t uxIndexToNotify, uint32_t ulValue,
    eNotifyAction eAction, uint32_t *pulPreviousNotificationValue,
...
/**
  ...
  \param[in]  xReturn            context dependent return value.
*/
extern void EvrFreeRTOSTasks_xTaskGenericNotifyFromISR_Return(
    BaseType_t xReturn);
...
/**
  ...
  \param[in]  xTaskToNotify             task handle.
  \param[in]  uxIndexToNotify           index within the tasks array of
  notification values. \param[in]  pxHigherPriorityTaskWoken pointer to variable
  where information if any task was woken will be stored.
*/
extern void EvrFreeRTOSTasks_vTaskGenericNotifyGiveFromISR(
...
/**
  ...
  \param[in]  xTask              task handle.
  \param[in]  uxIndexToClear     index within the tasks array of notification
  values.
*/
extern void EvrFreeRTOSTasks_xTaskGenericNotifyStateClear(
...
/**
  ...
  \param[in]  xReturn            execution status.
*/
extern void EvrFreeRTOSTasks_xTaskGenericNotifyStateClear_Return(
    BaseType_t xReturn);
...
/**
  ...
  \param[in]  xTask              task handle.
  \param[in]  uxIndexToClear     index within the tasks array of notification
  values. \param[in]  ulBitsToClear      bits to clear in notification value.
*/
extern void EvrFreeRTOSTasks_ulTaskGenericNotifyValueClear(
...
*/
extern void EvrFreeRTOSTasks_ulTaskGenericNotifyValueClear_Return(
    uint32_t ulReturn);
...
*/
extern void EvrFreeRTOSTasks_ulTaskGetRunTimeCounter_Return(
...
/**
  ...
  \param[in]  ulReturn           the percentage of the total run time consumed
  by the given task.
*/
...
*/
extern void EvrFreeRTOSTasks_ulTaskGetIdleRunTimeCounter_Return(
    uint32_t ulReturn);
...
/**
  ...
  by the idle task.
*/
extern void EvrFreeRTOSTasks_ulTaskGetIdleRunTimePercent_Return(
    uint32_t ulReturn);
...
/**
  \brief  Event on queue peek when queue is empty and no block time was
  specified (Error) \param[in]  pxQueue           pointer to queue object
  handle.
*/
...
*/
extern void EvrFreeRTOSQueue_QueueRegistryAdd(Queue_t pxQueue,
                                              const char *pcQueueName);

/**
  \brief  Event indicating the current running task is about to block while
  reading from an empty queue (Op) \param[in]  pxQueue           pointer to
  queue object handle.
*/
...
/**
  \brief  Event indicating the current running task is about to block while
  writting to a full queue (Op) \param[in]  pxQueue           pointer to queue
  object handle.
*/
...
*/
extern void EvrFreeRTOSTimers_TimerCommandSend(Timer_t pxTimer,
                                               uint32_t xCommandID,
...
/**
  ...
  \param[in]  xOptionalValue    optional command value.
*/
extern void EvrFreeRTOSTimers_TimerCommandReceived(Timer_t pxTimer,
                                                   uint32_t xCommandID,
                                                   uint32_t xOptionalValue);
...
/**
  ...
  \param[in]  xReturn           return value.
*/
extern void EvrFreeRTOSTimers_PendFuncCall(PendedFunction_t pxFunctionToPend,
                                           void *pvParameter1,
                                           uint32_t ulParameter2,
                                           uint32_t xReturn);

/**
  \brief  Event on pass of the function execution to the timer service task from
  the ISR (Op) \param[in]  pxFunctionToPend  pointer to callback function
  \param[in]  pvParameter1      function parameter 1.
  \param[in]  ulParameter2      function parameter 2.
  \param[in]  xReturn           return value.
*/
extern void EvrFreeRTOSTimers_PendFuncCallFromIsr(
    PendedFunction_t pxFunctionToPend, void *pvParameter1,
...
/**
  ...
  \param[in]  pvTimerID           identifier assigned to the timer being
  created. \param[in]  pxCallbackFunction  function to call when the timer
  expired.
*/
extern void EvrFreeRTOSTimers_xTimerCreate(
...
/**
  ...
  \param[in]  pvTimerID           identifier assigned to the timer being
  created. \param[in]  pxCallbackFunction  function to call when the timer
  expired. \param[in]  pxTimerBuffer       pointer to Timer object memory
  buffer.
*/
extern void EvrFreeRTOSTimers_xTimerCreateStatic(
    const char *pcTimerName, const TickType_t xTimerPeriodInTicks,
    const BaseType_t xAutoReload, void *pvTimerID,
...
/**
  ...
  \param[in]  pxNewTimer        Timer object handle.
*/
extern void EvrFreeRTOSTimers_xTimerCreateStatic_Return(
    TimerHandle_t pxNewTimer);
...
/**
  ...
  \param[in]  xOptionalValue            optional command value.
  \param[in]  pxHigherPriorityTaskWoken pointer to variable where information if
  any task was woken will be stored. \param[in]  xTicksToWait number of ticks to
  wait.
*/
extern void EvrFreeRTOSTimers_xTimerGenericCommandFromTask(
...
/**
  ...
  \param[in]  xReturn           execution status.
*/
extern void EvrFreeRTOSTimers_xTimerGenericCommandFromTask_Return(
    BaseType_t xReturn);
...
/**
  ...
  wait.
*/
extern void EvrFreeRTOSTimers_xTimerGenericCommandFromISR(
    TimerHandle_t xTimer, const BaseType_t xCommandID,
    const TickType_t xOptionalValue, BaseType_t *pxHigherPriorityTaskWoken,
    const TickType_t xTicksToWait);
...
/**
  ...
  \param[in]  xReturn           execution status.
*/
extern void EvrFreeRTOSTimers_xTimerGenericCommandFromISR_Return(
    BaseType_t xReturn);

/**
  \brief Event sent when function xTimerGetTimerDaemonTaskHandle is called
  (API).
*/
...
*/
extern void EvrFreeRTOSTimers_xTimerGetTimerDaemonTaskHandle_Return(
...
*/
extern void EvrFreeRTOSTimers_vTimerSetReloadMode(TimerHandle_t xTimer,
...
/**
  ...
  \param[in]  xTimer            Timer object handle.
  \param[in]  ppxTimerBuffer    pointer to memory where object buffer location
  is stored.
*/
extern void EvrFreeRTOSTimers_xTimerGetStaticBuffer(
...
/**
  ...
  \param[in]  xReturn           indication whether the timer is active or
  dormant.
*/
...
*/
extern void EvrFreeRTOSTimers_vTimerSetTimerID(TimerHandle_t xTimer,
                                               void *pvNewID);
...
/**
  ...
  \param[in]  xFunctionToPend           the callback function to execute from
  the timer daemon task. \param[in]  pvParameter1              the callback
  function first argument. \param[in]  ulParameter2              the callback
  function second argument. \param[in]  pxHigherPriorityTaskWoken pointer to
  variable where information if any task was woken will be stored.
*/
extern void EvrFreeRTOSTimers_xTimerPendFunctionCallFromISR(
...
/**
  ...
  \param[in]  xReturn           execution status.
*/
extern void EvrFreeRTOSTimers_xTimerPendFunctionCallFromISR_Return(
    BaseType_t xReturn);

/**
  \brief Event sent when function  is called (API).
  \param[in]  xFunctionToPend   the callback function to execute from the timer
  daemon task. \param[in]  pvParameter1      the callback function first
  argument. \param[in]  ulParameter2      the callback function second argument.
  \param[in]  xTicksToWait      the amount of time to wait until timer queue is
  free.
*/
extern void EvrFreeRTOSTimers_xTimerPendFunctionCall(
    PendedFunction_t xFunctionToPend, void *pvParameter1, uint32_t ulParameter2,
    TickType_t xTicksToWait);
...
*/
extern void EvrFreeRTOSTimers_uxTimerGetTimerNumber_Return(
...
*/
extern void EvrFreeRTOSTimers_vTimerSetTimerNumber(TimerHandle_t xTimer,
...
*/
extern void EvrFreeRTOSEventGroups_EventGroupSyncBlock(
    EventGroup_t pxEventGroup, uint32_t uxBitsToSet, uint32_t uxBitsToWaitFor);
...
*/
extern void EvrFreeRTOSEventGroups_EventGroupSyncEnd(EventGroup_t pxEventGroup,
...
/**
  ...
  \param[in]  uxBitsToWaitFor   event bits to wait for.
*/
extern void EvrFreeRTOSEventGroups_EventGroupWaitBitsBlock(
    EventGroup_t pxEventGroup, uint32_t uxBitsToWaitFor);
...
/**
  ...
  \param[in]  xTimeoutOccurred  timeout value.
*/
extern void EvrFreeRTOSEventGroups_EventGroupWaitBitsEnd(
    EventGroup_t pxEventGroup, uint32_t uxBitsToWaitFor,
    uint32_t xTimeoutOccurred);
...
*/
extern void EvrFreeRTOSEventGroups_EventGroupClearBits(
    EventGroup_t pxEventGroup, uint32_t uxBitsToClear);
...
/**
  ...
  \param[in]  uxBitsToClear     event bits that shall be cleared.
*/
extern void EvrFreeRTOSEventGroups_EventGroupClearBitsFromIsr(
    EventGroup_t pxEventGroup, uint32_t uxBitsToClear);
...
/**
  ...
  \param[in]  uxBitsToSet       event bits that shall be set.
*/
extern void EvrFreeRTOSEventGroups_EventGroupSetBits(EventGroup_t pxEventGroup,
                                                     uint32_t uxBitsToSet);
...
/**
  ...
  \param[in]  uxBitsToSet       event bits that shall be set.
*/
extern void EvrFreeRTOSEventGroups_EventGroupSetBitsFromIsr(
    EventGroup_t pxEventGroup, uint32_t uxBitsToSet);
...
*/
extern void EvrFreeRTOSEventGroups_xEventGroupCreateStatic(
...
*/
extern void EvrFreeRTOSEventGroups_xEventGroupCreateStatic_Return(
...
/**
  ...
  \param[in]  xEventGroup         pointer to Event Groups object handle.
*/
extern void EvrFreeRTOSEventGroups_xEventGroupCreate_Return(
    EventGroupHandle_t xEventGroup);
...
*/
extern void EvrFreeRTOSEventGroups_xEventGroupSync(
...
/**
  ...
  \param[in]  uxReturn            the bits after wait or when block time
  expired.
*/
...
/**
  ...
  \param[in]  xWaitForAllBits     specified if function waits until all bits are
  set. \param[in]  xTicksToWait        amount of time to wait for.
*/
extern void EvrFreeRTOSEventGroups_xEventGroupWaitBits(
...
/**
  ...
  expired.
*/
extern void EvrFreeRTOSEventGroups_xEventGroupWaitBits_Return(
...
*/
extern void EvrFreeRTOSEventGroups_xEventGroupClearBits(
...
*/
extern void EvrFreeRTOSEventGroups_xEventGroupClearBits_Return(
    EventBits_t uxReturn);
...
/**
  ...
  \param[in]  uxBitsToClear       the bits to clear.
*/
extern void EvrFreeRTOSEventGroups_xEventGroupClearBitsFromISR(
    EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToClear);
...
/**
  ...
  \param[in]  xReturn             execution status.
*/
extern void EvrFreeRTOSEventGroups_xEventGroupClearBitsFromISR_Return(
    BaseType_t xReturn);
...
/**
  ...
  \param[in]  xEventGroup         pointer to Event Groups object handle.
*/
extern void EvrFreeRTOSEventGroups_xEventGroupGetBitsFromISR(
    EventGroupHandle_t xEventGroup);
...
*/
extern void EvrFreeRTOSEventGroups_xEventGroupGetBitsFromISR_Return(
    EventBits_t uxReturn);
...
*/
extern void EvrFreeRTOSEventGroups_xEventGroupSetBits(
    EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet);
...
*/
extern void EvrFreeRTOSEventGroups_xEventGroupSetBits_Return(
    EventBits_t uxReturn);
...
/**
  ...
  \param[in]  xEventGroup         pointer to Event Groups object handle.
*/
extern void EvrFreeRTOSEventGroups_vEventGroupDelete(
    EventGroupHandle_t xEventGroup);
...
/**
  ...
  \param[in]  xEventGroup         pointer to Event Groups object handle.
  \param[in]  ppxEventGroupBuffer pointer to memory where pointer to Event
  Groups object data buffer is stored.
*/
extern void EvrFreeRTOSEventGroups_xEventGroupGetStaticBuffer(
    EventGroupHandle_t xEventGroup,
...
/**
  ...
  \param[in]  xReturn             execution status.
*/
extern void EvrFreeRTOSEventGroups_xEventGroupGetStaticBuffer_Return(
    BaseType_t xReturn);
...
*/
extern void EvrFreeRTOSEventGroups_vEventGroupSetBitsCallback(
...
*/
extern void EvrFreeRTOSEventGroups_vEventGroupClearBitsCallback(
...
/**
  ...
  \param[in]  pxHigherPriorityTaskWoken pointer to variable where information if
  any task was woken will be stored.
*/
extern void EvrFreeRTOSEventGroups_xEventGroupSetBitsFromISR(
    EventGroupHandle_t xEventGroup, const EventBits_t uxBitsToSet,
    BaseType_t *pxHigherPriorityTaskWoken);
...
/**
  ...
  \param[in]  xReturn             execution status.
*/
extern void EvrFreeRTOSEventGroups_xEventGroupSetBitsFromISR_Return(
    BaseType_t xReturn);
...
*/
extern void EvrFreeRTOSEventGroups_uxEventGroupGetNumber_Return(
    UBaseType_t xReturn);
...
*/
extern void EvrFreeRTOSEventGroups_vEventGroupSetNumber(
...
*/
extern void EvrFreeRTOSStreamBuf_StreamBufferCreateFailed(
...
/**
  ...
  \param[in]  uxIsMessageBuffer buffer type designator (0:stream, 1:message).
*/
extern void EvrFreeRTOSStreamBuf_StreamBufferCreateStaticFailed(
    StreamBuffer_t pxStreamBuffer, uint32_t uxIsMessageBuffer);
...
/**
  ...
  \param[in]  uxIsMessageBuffer buffer type designator (0:stream, 1:message).
*/
extern void EvrFreeRTOSStreamBuf_StreamBufferCreate(
    StreamBuffer_t pxStreamBuffer, uint32_t uxIsMessageBuffer);
...
/**
  ...
  \param[in]  pxStreamBuffer    pointer to Stream Buffer object handle.
*/
extern void EvrFreeRTOSStreamBuf_StreamBufferDelete(
...
/**
  ...
  \param[in]  pxStreamBuffer    pointer to Stream Buffer object handle.
*/
extern void EvrFreeRTOSStreamBuf_StreamBufferReset(
    StreamBuffer_t pxStreamBuffer);

/**
  \brief  Event on stream buffer send when buffer is full and sending task is
  blocked (Op) \param[in]  pxStreamBuffer    pointer to Stream Buffer object
  handle.
*/
extern void EvrFreeRTOSStreamBuf_StreamBufferBlockingOnSend(
    StreamBuffer_t pxStreamBuffer);

/**
  \brief  Event on stream buffer send when data is successfully copied into the
  buffer (Op) \param[in]  pxStreamBuffer    pointer to Stream Buffer object
  handle. \param[in]  xBytesSent        number of bytes copied into the buffer
*/
extern void EvrFreeRTOSStreamBuf_StreamBufferSend(StreamBuffer_t pxStreamBuffer,
                                                  uint32_t xBytesSent);

/**
  \brief  Event on stream buffer send when data is not copied into the buffer
  (Error) \param[in]  pxStreamBuffer    pointer to Stream Buffer object handle.
*/
extern void EvrFreeRTOSStreamBuf_StreamBufferSendFailed(
    StreamBuffer_t pxStreamBuffer);

/**
  \brief  Event on stream buffer send from ISR when data is successfully copied
  into the buffer (Op) \param[in]  pxStreamBuffer    pointer to Stream Buffer
  object handle. \param[in]  xBytesSent        number of bytes copied into the
  buffer
*/
extern void EvrFreeRTOSStreamBuf_StreamBufferSendFromIsr(
    StreamBuffer_t pxStreamBuffer, uint32_t xBytesSent);

/**
  \brief  Event on stream buffer receive when buffer is empty and receiving task
  is blocked (Op) \param[in]  pxStreamBuffer    pointer to Stream Buffer object
  handle.
*/
extern void EvrFreeRTOSStreamBuf_StreamBufferBlockingOnReceive(
    StreamBuffer_t pxStreamBuffer);

/**
  \brief  Event on stream buffer receive when data is successfully copied from
  the buffer (Op) \param[in]  pxStreamBuffer    pointer to Stream Buffer object
  handle. \param[in]  xReceivedLength   number of bytes copied from the buffer
*/
extern void EvrFreeRTOSStreamBuf_StreamBufferReceive(
    StreamBuffer_t pxStreamBuffer, uint32_t xReceivedLength);

/**
  \brief  Event on stream buffer receive when data is not copied from the buffer
  (Error) \param[in]  pxStreamBuffer    pointer to Stream Buffer object handle.
*/
extern void EvrFreeRTOSStreamBuf_StreamBufferReceiveFailed(
    StreamBuffer_t pxStreamBuffer);

/**
  \brief  Event on stream buffer receive from ISR when data is successfully
  copied from the buffer (Op) \param[in]  pxStreamBuffer    pointer to Stream
  Buffer object handle. \param[in]  xReceivedLength   number of bytes copied
  from the buffer
*/
extern void EvrFreeRTOSStreamBuf_StreamBufferReceiveFromIsr(
    StreamBuffer_t pxStreamBuffer, uint32_t xReceivedLength);
...
#define traceTASK_SWITCHED_IN() \
  EvrFreeRTOSTasks_TaskSwitchedIn(pxCurrentTCB, uxTopReadyPriority)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceTASK_PRIORITY_INHERIT_DISABLE))
#define traceTASK_PRIORITY_INHERIT(px, ux) \
  EvrFreeRTOSTasks_TaskPriorityInherit(px, ux)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceTASK_PRIORITY_DISINHERIT_DISABLE))
#define traceTASK_PRIORITY_DISINHERIT(px, ux) \
  EvrFreeRTOSTasks_TaskPriorityDisinherit(px, ux)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceMOVED_TASK_TO_READY_STATE_DISABLE))
#define traceMOVED_TASK_TO_READY_STATE(px) \
  EvrFreeRTOSTasks_MovedTaskToReadyState(px)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(tracePOST_MOVED_TASK_TO_READY_STATE_DISABLE))
#define tracePOST_MOVED_TASK_TO_READY_STATE(px) \
  EvrFreeRTOSTasks_PostMovedTaskToReadyState(px)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceLOW_POWER_IDLE_BEGIN_DISABLE))
#define traceLOW_POWER_IDLE_BEGIN() \
  EvrFreeRTOSTasks_LowPowerIdleBegin(xExpectedIdleTime)
#endif
...
#define traceRETURN_xTaskCreateRestrictedStaticAffinitySet \
...
#define traceRETURN_xTaskCreateRestricted \
...
#define traceRETURN_xTaskCreateRestrictedAffinitySet \
...
#define traceRETURN_xTaskCreateAffinitySet \
...
#define traceRETURN_xTaskResumeFromISR \
...
#define traceRETURN_uxTaskGetNumberOfTasks \
...
#define traceENTER_xTaskGetStaticBuffers(x, ppux, ppx) \
  EvrFreeRTOSTasks_xTaskGetStaticBuffers(x, ppux, (uint32_t)ppx)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceRETURN_xTaskGetStaticBuffers_DISABLE))
#define traceRETURN_xTaskGetStaticBuffers \
...
#define traceENTER_xTaskGetApplicationTaskTag \
...
#define traceENTER_vTaskPlaceOnUnorderedEventList \
...
#define traceENTER_xTaskRemoveFromEventList \
  EvrFreeRTOSTasks_xTaskRemoveFromEventList
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceRETURN_xTaskRemoveFromEventList_DISABLE))
#define traceRETURN_xTaskRemoveFromEventList \
  EvrFreeRTOSTasks_xTaskRemoveFromEventList_Return
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceENTER_vTaskRemoveFromUnorderedEventList_DISABLE))
#define traceENTER_vTaskRemoveFromUnorderedEventList \
...
#define traceENTER_vTaskInternalSetTimeOutState \
...
#define traceRETURN_xTaskCheckForTimeOut \
...
#define traceRETURN_uxTaskGetTaskNumber \
...
#define traceENTER_vTaskSetThreadLocalStoragePointer \
...
#define traceENTER_pvTaskGetThreadLocalStoragePointer \
...
#define traceENTER_vTaskAllocateMPURegions \
...
#define traceRETURN_xTaskGetSchedulerState \
...
#define traceRETURN_vTaskEnterCriticalFromISR \
...
#define traceENTER_vTaskExitCriticalFromISR \
...
#define traceENTER_vTaskGetRunTimeStatistics \
...
#define traceRETURN_uxTaskResetEventItemValue \
...
#define traceRETURN_pvTaskIncrementMutexHeldCount \
...
#define traceRETURN_ulTaskGenericNotifyTake \
...
#define traceRETURN_xTaskGenericNotifyWait \
...
#define traceRETURN_xTaskGenericNotify \
...
#define traceRETURN_xTaskGenericNotifyFromISR \
...
#define traceRETURN_ulTaskGetIdleRunTimeCounter \
...
#define traceRETURN_ulTaskGetIdleRunTimePercent \
...
#define traceRETURN_xTaskGetMPUSettings \
...
#define traceGIVE_MUTEX_RECURSIVE_FAILED(px) \
  EvrFreeRTOSQueue_GiveMutexRecursiveFailed(px)
#endif
...
#define traceTAKE_MUTEX_RECURSIVE_FAILED(px) \
  EvrFreeRTOSQueue_TakeMutexRecursiveFailed(px)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceCREATE_COUNTING_SEMAPHORE_DISABLE))
#define traceCREATE_COUNTING_SEMAPHORE() \
  EvrFreeRTOSQueue_CreateCountingSemaphore(xHandle)
#endif
...
#define traceQUEUE_SEND_FROM_ISR_FAILED(px) \
  EvrFreeRTOSQueue_QueueSendFromIsrFailed(px)
#endif
...
#define traceQUEUE_RECEIVE_FROM_ISR_FAILED(px) \
  EvrFreeRTOSQueue_QueueReceiveFromIsrFailed(px)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceQUEUE_PEEK_FROM_ISR_FAILED_DISABLE))
#define traceQUEUE_PEEK_FROM_ISR_FAILED(px) \
  EvrFreeRTOSQueue_QueuePeekFromIsrFailed(px)
#endif
...
#define traceQUEUE_REGISTRY_ADD(px, pc) \
  EvrFreeRTOSQueue_QueueRegistryAdd(px, pc)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceBLOCKING_ON_QUEUE_RECEIVE_DISABLE))
#define traceBLOCKING_ON_QUEUE_RECEIVE(px) \
  EvrFreeRTOSQueue_BlockingOnQueueReceive(px)
#endif
...
#define traceTIMER_COMMAND_SEND(pxT, xC, xO, xR) \
  EvrFreeRTOSTimers_TimerCommandSend(pxT, xC, xO, xR)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceTIMER_COMMAND_RECEIVED_DISABLE))
#define traceTIMER_COMMAND_RECEIVED(px, xC, xO) \
  EvrFreeRTOSTimers_TimerCommandReceived(px, xC, xO)
#endif
...
#define tracePEND_FUNC_CALL(px, pv, ul, x) \
  EvrFreeRTOSTimers_PendFuncCall(px, pv, ul, x)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(tracePEND_FUNC_CALL_FROM_ISR_DISABLE))
#define tracePEND_FUNC_CALL_FROM_ISR(px, pv, ul, x) \
  EvrFreeRTOSTimers_PendFuncCallFromIsr(px, pv, ul, x)
#endif
...
#define traceRETURN_xTimerCreateTimerTask \
...
#define traceRETURN_xTimerCreateStatic \
...
#define traceRETURN_xTimerGenericCommandFromTask \
...
#define traceRETURN_xTimerGenericCommandFromISR \
...
#define traceRETURN_xTimerGetTimerDaemonTaskHandle \
...
#define traceRETURN_xTimerGetReloadMode \
...
#define traceRETURN_uxTimerGetReloadMode \
...
#define traceRETURN_xTimerGetExpiryTime \
  EvrFreeRTOSTimers_xTimerGetExpiryTime_Return
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceENTER_xTimerGetStaticBuffer_DISABLE))
#define traceENTER_xTimerGetStaticBuffer(x, ppx) \
  EvrFreeRTOSTimers_xTimerGetStaticBuffer(x, (uint32_t)ppx)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceRETURN_xTimerGetStaticBuffer_DISABLE))
#define traceRETURN_xTimerGetStaticBuffer \
...
#define traceRETURN_xTimerIsTimerActive \
...
#define traceEVENT_GROUP_SYNC_BLOCK(px, uxS, uxW) \
  EvrFreeRTOSEventGroups_EventGroupSyncBlock(px, uxS, uxW)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceEVENT_GROUP_SYNC_END_DISABLE))
#define traceEVENT_GROUP_SYNC_END(px, uxS, uxW, x) \
  EvrFreeRTOSEventGroups_EventGroupSyncEnd(px, uxS, uxW, x)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceEVENT_GROUP_WAIT_BITS_BLOCK_DISABLE))
#define traceEVENT_GROUP_WAIT_BITS_BLOCK(px, ux) \
  EvrFreeRTOSEventGroups_EventGroupWaitBitsBlock(px, ux)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceEVENT_GROUP_WAIT_BITS_END_DISABLE))
#define traceEVENT_GROUP_WAIT_BITS_END(px, ux, x) \
  EvrFreeRTOSEventGroups_EventGroupWaitBitsEnd(px, ux, x)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceEVENT_GROUP_CLEAR_BITS_DISABLE))
#define traceEVENT_GROUP_CLEAR_BITS(px, ux) \
  EvrFreeRTOSEventGroups_EventGroupClearBits(px, ux)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceEVENT_GROUP_CLEAR_BITS_FROM_ISR_DISABLE))
#define traceEVENT_GROUP_CLEAR_BITS_FROM_ISR(px, ux) \
  EvrFreeRTOSEventGroups_EventGroupClearBitsFromIsr(px, ux)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceEVENT_GROUP_SET_BITS_DISABLE))
#define traceEVENT_GROUP_SET_BITS(px, ux) \
  EvrFreeRTOSEventGroups_EventGroupSetBits(px, ux)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceEVENT_GROUP_SET_BITS_FROM_ISR_DISABLE))
#define traceEVENT_GROUP_SET_BITS_FROM_ISR(px, ux) \
  EvrFreeRTOSEventGroups_EventGroupSetBitsFromIsr(px, ux)
#endif
...
#define traceRETURN_xEventGroupCreate \
...
#define traceRETURN_xEventGroupSync \
...
#define traceRETURN_xEventGroupSetBits \
...
#define traceENTER_xEventGroupGetStaticBuffer(x, ppx) \
  EvrFreeRTOSEventGroups_xEventGroupGetStaticBuffer(x, (uint32_t)ppx)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceRETURN_xEventGroupGetStaticBuffer_DISABLE))
#define traceRETURN_xEventGroupGetStaticBuffer \
...
#define traceENTER_vEventGroupClearBitsCallback \
...
#define traceSTREAM_BUFFER_CREATE_FAILED(ux) \
  EvrFreeRTOSStreamBuf_StreamBufferCreateFailed(ux)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceSTREAM_BUFFER_CREATE_STATIC_FAILED_DISABLE))
#define traceSTREAM_BUFFER_CREATE_STATIC_FAILED(x, ux) \
  EvrFreeRTOSStreamBuf_StreamBufferCreateStaticFailed(x, ux)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceSTREAM_BUFFER_CREATE_DISABLE))
#define traceSTREAM_BUFFER_CREATE(px, x) \
  EvrFreeRTOSStreamBuf_StreamBufferCreate(px, x)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceSTREAM_BUFFER_DELETE_DISABLE))
#define traceSTREAM_BUFFER_DELETE(px) \
  EvrFreeRTOSStreamBuf_StreamBufferDelete(px)
#endif
...
#define traceBLOCKING_ON_STREAM_BUFFER_SEND(px) \
  EvrFreeRTOSStreamBuf_StreamBufferBlockingOnSend(px)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceSTREAM_BUFFER_SEND_DISABLE))
#define traceSTREAM_BUFFER_SEND(px, x) \
  EvrFreeRTOSStreamBuf_StreamBufferSend(px, x)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceSTREAM_BUFFER_SEND_FAILED_DISABLE))
#define traceSTREAM_BUFFER_SEND_FAILED(px) \
  EvrFreeRTOSStreamBuf_StreamBufferSendFailed(px)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceSTREAM_BUFFER_SEND_FROM_ISR_DISABLE))
#define traceSTREAM_BUFFER_SEND_FROM_ISR(px, x) \
  EvrFreeRTOSStreamBuf_StreamBufferSendFromIsr(px, x)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceBLOCKING_ON_STREAM_BUFFER_RECEIVE_DISABLE))
#define traceBLOCKING_ON_STREAM_BUFFER_RECEIVE(px) \
  EvrFreeRTOSStreamBuf_StreamBufferBlockingOnReceive(px)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceSTREAM_BUFFER_RECEIVE_DISABLE))
#define traceSTREAM_BUFFER_RECEIVE(px, x) \
  EvrFreeRTOSStreamBuf_StreamBufferReceive(px, x)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceSTREAM_BUFFER_RECEIVE_FAILED_DISABLE))
#define traceSTREAM_BUFFER_RECEIVE_FAILED(px) \
  EvrFreeRTOSStreamBuf_StreamBufferReceiveFailed(px)
#endif

#if (!defined(EVR_FREERTOS_DISABLE) && \
     !defined(traceSTREAM_BUFFER_RECEIVE_FROM_ISR_DISABLE))
#define traceSTREAM_BUFFER_RECEIVE_FROM_ISR(px, x) \
  EvrFreeRTOSStreamBuf_StreamBufferReceiveFromIsr(px, x)
#endif
