...
// Error indication (returned by \ref osThreadGetClass and \ref
// osThreadGetZone).
...
typedef enum {
  ...
  osErrorSafetyClass =
      -7,  ///< Operation denied because of safety class violation.
  osStatusReserved =
      0x7FFFFFFF  ///< Prevents enum down-size compiler optimization.
} osStatus_t;
...
/// \param[in]     thread_id     thread ID obtained by \ref osThreadNew or \ref
/// osThreadGetId. \return safety class of the specified thread.
uint32_t osThreadGetClass(osThreadId_t thread_id);

/// Get MPU protected zone of a thread.
/// \param[in]     thread_id     thread ID obtained by \ref osThreadNew or \ref
/// osThreadGetId. \return MPU protected zone of the specified thread.
...
/// \param[in]     thread_id thread ID obtained by \ref osThreadNew or \ref
/// osThreadGetId. \return new watchdog reload value or 0 to stop the watchdog.
