...
///     """
STATIC mp_obj_t mod_trezorui_Display_cover_background_set_visible(
    mp_obj_t self, mp_obj_t visible) {
  bool vis = mp_obj_is_true(visible);
  lcd_cover_background_set_visible(vis);
  return mp_const_none;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorui_Display_cover_background_set_visible_obj,
...
///     """
STATIC mp_obj_t mod_trezorui_Display_cover_background_set_image(
    mp_obj_t self, mp_obj_t image_data) {
  mp_buffer_info_t buf = {0};
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorui_Display_cover_background_set_image_obj,
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorui_Display_cover_background_load_jpeg_obj,
...
///     """
STATIC mp_obj_t mod_trezorui_Display_cover_background_move_to_y(
    mp_obj_t self, mp_obj_t y_position) {
  mp_int_t y = mp_obj_get_int(y_position);
  lcd_cover_background_move_to_y((int16_t)y);
  return mp_const_none;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorui_Display_cover_background_move_to_y_obj,
...
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorui_Display_cover_background_reload_statusbar_from_jpeg_obj,
    mod_trezorui_Display_cover_background_reload_statusbar_from_jpeg);
...
///     """
STATIC mp_obj_t mod_trezorui_Display_cover_background_set_statusbar_opacity(
    mp_obj_t self, mp_obj_t transparent) {
  bool is_transparent = mp_obj_is_true(transparent);
  // lcd_cover_background_set_statusbar_opacity(is_transparent); // Function
  // removed
  return mp_const_none;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorui_Display_cover_background_set_statusbar_opacity_obj,
...
///     """
STATIC mp_obj_t mod_trezorui_Display_cover_background_animate_to_y(
    mp_obj_t self, mp_obj_t target_y, mp_obj_t duration_ms) {
...
STATIC MP_DEFINE_CONST_FUN_OBJ_3(
    mod_trezorui_Display_cover_background_animate_to_y_obj,
...
///     """
STATIC mp_obj_t
mod_trezorui_Display_cover_background_is_visible(mp_obj_t self) {
  bool is_visible = lcd_cover_background_is_visible();
  return mp_obj_new_bool(is_visible);
}
STATIC MP_DEFINE_CONST_FUN_OBJ_1(
    mod_trezorui_Display_cover_background_is_visible_obj,
...
///     """
STATIC mp_obj_t mod_trezorui_Display_homescreen_start_slide(
    mp_obj_t self, mp_obj_t target_y, mp_obj_t duration_ms) {
  mp_int_t y = mp_obj_get_int(target_y);
  mp_int_t duration = mp_obj_get_int(duration_ms);
  if (duration < 0 || duration > 5000) {
    mp_raise_ValueError("Duration must be between 0 and 5000ms");
  }
  lvgl_homescreen_start_slide((int16_t)y, (uint16_t)duration);
  return mp_const_none;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_3(
    mod_trezorui_Display_homescreen_start_slide_obj,
    mod_trezorui_Display_homescreen_start_slide);

/// def homescreen_set_wallpaper_obj(self, img_obj: int) -> None:
///     """
///     Set LVGL wallpaper object pointer for animation.
///     """
STATIC mp_obj_t mod_trezorui_Display_homescreen_set_wallpaper_obj(
    mp_obj_t self, mp_obj_t img_obj) {
  mp_int_t obj_ptr = mp_obj_get_int(img_obj);
  lvgl_homescreen_set_wallpaper_obj((void *)obj_ptr);
  return mp_const_none;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_2(
    mod_trezorui_Display_homescreen_set_wallpaper_obj_obj,
    mod_trezorui_Display_homescreen_set_wallpaper_obj);

/// def homescreen_is_sliding(self) -> bool:
///     """
///     Check if LVGL wallpaper slide animation is active.
///     """
STATIC mp_obj_t mod_trezorui_Display_homescreen_is_sliding(mp_obj_t self) {
  bool is_sliding = lvgl_homescreen_is_sliding();
  return mp_obj_new_bool(is_sliding);
}
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_trezorui_Display_homescreen_is_sliding_obj,
                                 mod_trezorui_Display_homescreen_is_sliding);

/// def homescreen_stop_slide(self) -> None:
///     """
///     Stop LVGL wallpaper slide animation.
///     """
STATIC mp_obj_t mod_trezorui_Display_homescreen_stop_slide(mp_obj_t self) {
  lvgl_homescreen_stop_slide();
  return mp_const_none;
}
STATIC MP_DEFINE_CONST_FUN_OBJ_1(mod_trezorui_Display_homescreen_stop_slide_obj,
                                 mod_trezorui_Display_homescreen_stop_slide);
...
STATIC const mp_rom_map_elem_t mod_trezorui_Display_locals_dict_table[] = {
    ...
    {MP_ROM_QSTR(MP_QSTR_homescreen_start_slide),
     MP_ROM_PTR(&mod_trezorui_Display_homescreen_start_slide_obj)},
    {MP_ROM_QSTR(MP_QSTR_homescreen_set_wallpaper_obj),
     MP_ROM_PTR(&mod_trezorui_Display_homescreen_set_wallpaper_obj_obj)},
    {MP_ROM_QSTR(MP_QSTR_homescreen_is_sliding),
     MP_ROM_PTR(&mod_trezorui_Display_homescreen_is_sliding_obj)},
    {MP_ROM_QSTR(MP_QSTR_homescreen_stop_slide),
     MP_ROM_PTR(&mod_trezorui_Display_homescreen_stop_slide_obj)},
