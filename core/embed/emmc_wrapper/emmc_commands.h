...
// SDRAM BUFFER
#define SDRAM_BOOLOADER_BUFFER_RECV_LEN (9 * 1024 * 1024)
#define SDRAM_BOOLOADER_BUFFER_SEND_LEN (9 * 1024 * 1024)
#define SDRAM_BOOLOADER_BUFFER_MISC_LEN (9 * 1024 * 1024)
